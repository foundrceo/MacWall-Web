...
const PAGE_DESCRIPTION =
  `MacWall is the native macOS app for cinematic live wallpapers, controlled from the menu bar, with near-zero battery impact and a Lock Screen on ${macwallMinimumMacOSVersion}. One-time $7.99, no subs.`
