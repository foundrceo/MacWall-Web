    ...
    <>
      ...
      <LegalSection id="information-we-collect" title="Information We Collect">
        <p>
          ...
          Some technical and purchase-related data is collected automatically or
        ...
        <ul className={legalBulletList}>
          ...
          <li>
            ...
            Pro, we send your license key and a stable hardware identifier (such
            as your Mac&apos;s platform UUID) to our payment and licensing
            provider so your purchase can be validated and bound to this device.
          </li>
          <li>
            <strong>Purchase data:</strong> Checkout is handled by our merchant
            (Whop). We do not collect or store your full payment card details on
            our servers. We may receive transaction identifiers, license status,
            and your email for fulfillment and support.
          </li>
          <li>
            <strong>Website and infrastructure logs:</strong> When you visit{" "}
            {siteHost}, hosting providers may log standard data such as IP
            address, user agent, and request time for security and reliability.
          </li>
          <li>
      ...
      <LegalSection id="how-we-use-data" title="How We Use Collected Data">
        ...
        <ul className={legalBulletList}>
          ...
          <li>
            Provide the cloud catalog, downloads, search, and related features.
          </li>
          <li>
      ...
      <LegalSection id="what-we-do-not-do" title="What We Do Not Use Data For">
        <ul className={legalBulletList}>
      ...
      >
        ...
        <ul className={legalBulletList}>
          ...
          <li>
            <strong>Cloud infrastructure:</strong> APIs and databases that power
            the catalog and related backend services.
          </li>
          <li>
      ...
      <LegalSection id="your-content" title="Catalog Content and Local Imports">
        <p>
        ...
        <ul className={legalBulletList}>
          <li>
            Video files you import from your own storage stay on your Mac unless
            you explicitly use a feature that uploads them (the current app
            keeps personal imports local).
          </li>
          <li>
      ...
      <LegalSection id="gdpr-basis" title="Legal Basis for Processing (GDPR)">
        ...
        <ul className={legalBulletList}>
          ...
          <li>
            ...
            communications beyond essentials).
          </li>
        </ul>
      </LegalSection>
      ...
      >
        <p>
          California residents may request disclosure, deletion, and correction
          of personal information, and opt out of certain sharing, subject to
          exceptions. To submit a request, email{" "}
      ...
      <LegalSection id="security" title="Data Security">
        <p>
          ...
          monitoring. No method of transmission or storage is completely secure.
        </p>
      </LegalSection>

      <LegalSection id="children" title="Children's Privacy">
        <p>
          The App and Site are not directed at children under 13 (or the minimum
          age in your region), and we do not knowingly collect their personal
          information. Contact us if you believe we have done so inadvertently.
        </p>
      </LegalSection>
      ...
      <LegalSection id="changes" title="Changes to This Policy">
        <p>
          ...
          Continued use after updates constitutes acceptance where permitted by
          law.
        </p>
      </LegalSection>
      ...
      <LegalSection id="feedback" title="Feedback &amp; Information">
        <p>
          ...
          in this policy may change without notice apart from the posting above.
          Copyright © {year} {macwall.name}. All rights reserved. Contact:{" "}
          <a href={`mailto:${macwall.supportEmail}`}>{macwall.supportEmail}</a>.
          Website:{" "}
