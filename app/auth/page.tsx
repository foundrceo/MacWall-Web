...
const Page = () => {
  return (
    <div className="relative flex h-full min-h-screen w-full flex-col items-center justify-center gap-6 p-4">
      ...
      <Card className="relative z-10 w-full max-w-105 rounded-4xl border-0 bg-background shadow-xl backdrop-blur-sm dark:bg-background/80">
        <CardContent className="mx-auto max-w-sm space-y-8 px-8 pt-8 pb-8">
