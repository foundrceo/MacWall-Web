...
export function buildDefaultMarketingPricing(): MarketingPricing {
  ...
  return {
    ...
    pricingProDescription: `One-time ${salePrice}. Full catalog, Lock Screen video, unlimited playlists, and lifetime updates on one Mac per license, no subscription, ever.`,
...
export function buildIndiaMarketingPricingFallback(): MarketingPricing {
  ...
  return {
    ...
    pricingProDescription: `50% off with ${INDIA_PROMO_CODE}. Full catalog, Lock Screen video, and lifetime updates on one Mac per license.`,
