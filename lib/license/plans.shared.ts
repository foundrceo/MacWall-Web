...
export function deviceLimitUserMessage(maxDevices: number): string {
  ...
  return `This license is already active on ${maxDevices} Macs. Unlink a device in Settings → Devices on one of your linked Macs, or upgrade to Pro+ at macwall.app/pricing.`
}
