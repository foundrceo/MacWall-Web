...
| **Pro** | **$9.99** one-time (was $14.99) | **$4.99** | **50% off** | 1,000+ live wallpapers, Lock Screen & Screen Saver, import videos, up to **3 Macs**, Music Sync, lifetime updates |
| **Pro+** | **$14.99** one-time (was $24.99) | **$7.49** | **50% off** | everything in Pro on up to **5 Macs** |

headline on `/pricing`: **Pay once. Pro forever.** — limited price, no subscriptions for new buyers. India visitors see **$4.99 / $7.49** on the cards; Checkout uses the same catalog Prices as everyone else and auto-applies coupon **INDIA50** (full payment-method support + Adaptive Pricing).
