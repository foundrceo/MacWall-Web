...
export default function Testimonial() {
  return (
    <div className="4xl:max-w-[90rem] mx-auto flex max-w-6xl flex-col gap-12 px-4 pt-30 pb-12 lg:pt-54">
      <motion.section
      ...
      >
        <h2 className="4xl:text-6xl font-heading text-2xl font-normal tracking-tight text-foreground md:text-4xl">
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-6">
        <motion.div
