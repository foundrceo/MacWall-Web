...
export default function LogoCloud() {
  ...
  return (
    <motion.div
      ...
      className="mx-auto mt-4 flex max-w-6xl flex-col items-center justify-center gap-8 md:gap-4 2xl:max-w-full"
    >
      <motion.p
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.2 }}
        className="4xl:text-3xl text-center font-light"
      >
