...
function IndiaFlashBanner() {
  ...
  return (
    <Link
      ...
      className="announcement-india-banner mx-auto flex max-w-7xl flex-col items-center justify-center gap-0.5 bg-white px-4 py-2.5 text-center transition-opacity hover:opacity-90 sm:h-9 sm:flex-row sm:gap-0 sm:py-0"
    >
